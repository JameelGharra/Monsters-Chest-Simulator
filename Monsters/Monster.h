...
struct Monster {
    ...
    Monster (const bool &enraged, const std::set<Drop>* const &guaranteed_drops, const std::set<Drop>* const &food_drops,
             const std::set<Drop>* const &main_drops, const std::set<Drop>* const &unique_drops);
